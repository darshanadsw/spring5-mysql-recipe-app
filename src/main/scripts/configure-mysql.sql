...
CREATE USER 'dw_dev_user'@'localhost' INDENTIFIED BY 'dw';
CREATE USER 'dw_prod_user'@'localhost' INDENTIFIED BY 'dw';
CREATE USER 'dw_dev_user'@'%' INDENTIFIED BY 'dw';
CREATE USER 'dw_prod_user'@'%' INDENTIFIED BY 'dw';
